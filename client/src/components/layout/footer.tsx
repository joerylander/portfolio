...
export default function Footer() {
  ...
  return (
    <footer className="mx-8 flex h-28 min-h-20 snap-start items-center justify-between">
      <p
      ...
      <div className="flex space-x-12">
        ...
        <a className="h-8 w-8" href="https://x.com/CyberJojo9" target="_blank">
      ...
      <a
        ...
        className={`${azaret_mono.className} text-sm`}
      >
