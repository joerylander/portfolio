...
const ExperienceCard = (props: Props) => {
  return (
    <article
      className='flex flex-col rounded-lg item-center space-y-2 flex-shrink-0
       w-[500px] md:w-[600px] xl:w-[900px] snap-center p-10 bg-[#292929] hover:opacity-100
    ...
    >
      ...
      <div className='px-0 md:px-10'>
        <h4 className='text-4xl font-light'>Work Title (CEO OF PAPFAM)</h4>
        <p className='font-bold text-2xl mt-1'>Company name (PAPFAM)</p>
