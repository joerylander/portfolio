    ...
    <>
      ...
      <article className="flex max-w-2xl flex-col gap-2">
        <p className={paragraphStyle}>
          Hello there, I'm Joe Rylander, a web developer and designer focused on
          helping fitness professionals and small businesses build
        ...
        <p className={paragraphStyle}>
          Whether you're a personal trainer, gym owner, or wellness coach, I
          understand what your clients are looking for online — trust,
        ...
        <p className={paragraphStyle}>
          ...
          calisthenics focued workout (think{' '}
